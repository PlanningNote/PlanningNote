	...
	<form name="f" action="admin_askReply.do" method="post"
		...
		<table border="1" width="600">
			...
			<tr>
				...
				<td><input type="text" name="writer" value="${sessionScope.mynick}"></td>
			</tr>
			<tr>
				<th bgcolor="grey" width="20%">제목</th>
				<td><input type="text" name="subject" size="50" value="[답글]"></td>
			</tr>
			<tr>
				<th bgcolor="grey" width="20%">내 용</th>
				<td><textarea name="content" rows="12" cols="55" size="50"></textarea></td>
			</tr>
			<tr>
			...
			<tr bgcolor="grey">
				<td align="center" colspan="2">
					...
					<input type="button" value="목록보기" onclick="window.location='admin_askList.do'">
				</td>
			</tr>
		</table>
	</form>
