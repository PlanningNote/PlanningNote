	...
	<form name="f" action="admin_noticeUpdate.do" method="post"
		...
		<table border="1" width="600">
			...
			<tr>
				...
				<td><textarea name="content" rows="12" cols="65" 	class="box">${getNoticeBoard.content}</textarea></td>
			</tr>
			<tr>
			...
			<tr bgcolor="pink">
				<td align="center" colspan="2">
					...
					<input type="button" value="목록보기" onclick="window.location='admin_noticeList.do'"></td>
			</tr>
		</table>
	</form>
</div>
