...
String path = request.getSession().getServletContext().getRealPath("/") + File.separator + "img"; // 이미지가 저장될 주소
String filename = "C:/Users/ITBANK403-03/git/PlanningNote/Project/WebContent/WEB-INF/fileFolder";
